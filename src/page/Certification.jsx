  ...
  return (
    <Section>
      <div>
        ...
        <SandBoxDiv>
          <CertificationInput type='sand' value={sandEmail} onChange={onChangeSandEmail} placeholder="이메일을 적어주세요."/>
          <Button type='resand' onClick={sandEmailBtnHandler}>인증번호 발송</Button>
        </SandBoxDiv>

        {!isEmail ?<WarningMessage>{warningMessage}</WarningMessage>:<>
        <SandBoxDiv>
